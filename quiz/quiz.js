...
class Execute extends React.Component {
  ...
  render() {
    ...
    if (this.state.finished == true) {
      ...
      tekstit.push(<p><strong>You scored {this.state.correctAnswers}/{this.props.quiz.length}.</strong> In case you are interested to find out even more, feel free to <a href="" class="hyperosoite">contact me</a> via mail, LinkedIn or Skype.</p>);
    } else {
