...
;(function ( $, window, document, undefined ) {
	...
	var pluginName = 'momentum',
		defaults = {
			barSelector: null,			// Optional selector for progress bar
			customCss: false,			// Override all default styles with custom CSS
			barColor: '#9e9e9e',		// Color of progress bar
			thickness: 6,				// Thickness of progress bar
			progressColor: '#6ab446',	// Color of progress percentage
			offset: 'bottom',			// Where progress is calculated within viewport (middle, top, bottom, int)
