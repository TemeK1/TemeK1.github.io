...
class Execute extends React.Component {
  ...
  render() {
    ...
    if (this.state.finished == true) {
      tekstit.push(<p><strong>Kysely on tehty!</strong></p>);
      tekstit.push(<p><strong>Pisteitä sait {this.state.correctAnswers}/{this.props.quiz.length}.</strong> Jos sinua kiinnostaa kuulla lisää ja/tai palkata minut niin <a href="#contact" class="hyperosoite">nakkaahan viestiä</a> lomakkeen, puhelinnumeron tai LinkedInin kautta.</p>);
    } else {
      ...
      if (this.props.lopussa == true) {
        ...
        if (this.state.tarkista == true) {
          if (this.state.lastOneCorrect == true) {
            nappula.push(<p>Oikein!</p>);
          } else {
            nappula.push(<p>Väärin!</p>);
          }
          nappula.push(<button className="quizButton" onClick={this.soita}>Seuraava kysymys</button>);
        }
        for (let i = 0; i < this.props.kysymys.options.length; i++) {
